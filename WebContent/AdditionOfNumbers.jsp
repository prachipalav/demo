...
<body background="background/dil1.jpg">
	<table cellspacing="15" align="center">
		<tr>
		<h1 style="color:red;text-align:center;font-family: cursive;">Addition of Numbers</h1>
			<form method="post">
					<td><img src="images\one.jpg" style="height: 100px; width: 100px" /></td> 
					<td><img src="images\p.png" style="height: 100px; width: 100px" /></td> 
					<td><img src="images\one.jpg" style="height: 100px; width: 100px" /></td> 
	...
	<%
		...
		try {
			...
			ResultSet rs = ps.executeQuery("select* from addition where id = " + id);
